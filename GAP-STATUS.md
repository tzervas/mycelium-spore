# Gap status — `mycelium-spore`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-spore` |
| **Role** | spore packager |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-spore-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Content-addressed deployable |
